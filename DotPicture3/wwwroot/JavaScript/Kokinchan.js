var Kokinchan = /** @class */ (function () {
    ...
    Kokinchan.prototype.initialize = function () {
    ...
    Kokinchan.prototype.initializeBlueList = function () {
    ...
    Kokinchan.prototype.initializeWhiteList = function () {
        var l = this._WhiteList;
    };
    Kokinchan.prototype.initializeGreenList = function () {
        var l = this._GreenList;
    };
    Kokinchan.prototype.initializeOrangeList = function () {
        var l = this._OrangeList;
    };
    Kokinchan.prototype.initializeRedList = function () {
        var l = this._RedList;
    };
    Kokinchan.prototype.initializeBlackList = function () {
        var l = this._BlackList;
    };
    Kokinchan.prototype.StartButton_Click = function () {
        var div = document.getElementById("KokinchanPanel");
